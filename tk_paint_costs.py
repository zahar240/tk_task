...
calculate and output the total cost of your project rounded up to the nearest whole number.
...
def total_prise(count):
    total_prise = canvas_brushes + count * color  + (canvas_brushes + count * color) / 100 * tax
    return int(total_prise)

colors_count = int(input("Введите количество красок: "))

print(total_prise(colors_count))